...
- [x] S5 · Recomandări — **redus prin decizie și livrat astfel**: 50% de fiecare parte, fără cod, fără link, fără atribuire automată — deci nici măsurare a canalului. Acordarea e **un buton în profilul familiei** (`POST /discounts/referral`): serverul pune 50%, „Recomandare" și luna următoare, pe ceasul școlii, iar a doua reducere procentuală pe aceeași lună e refuzată, fiindcă s-ar aduna la o lună gratuită. `/admin/reduceri` rămâne pentru orice altă reducere și pentru ștergere
