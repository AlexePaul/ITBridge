...
**Ce lipsește:** branch protection pe `release/prod`, cu `verify` și `e2e` ca verificări obligatorii. Se
...
CI verde obligatoriu pe `release/prod`. Peste 80% acoperire pe modulele de bani și autorizare. Niciun test
