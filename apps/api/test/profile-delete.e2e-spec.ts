...
/**
 * `DELETE /profiles/:id` against a real database — because the whole question is what the *database*
 * does after the statement, and no mock can answer it.
 *
 ...
 * that would matter.
 */
describe('Deleting a profile (e2e)', () => {
