...
export const TEMPLATE_DEFAULTS: readonly TemplateDefinition[] = [
    ...
    },
    {
        ...
        variables: [
            ...
            {
                name: 'portalNote',
                description: 'Propoziția dinaintea linkului: portalul, pentru o familie cu cont; pentru o familie la probă, fără cont, pagina de contact',
            },
            {
                name: 'portalUrl',
                description: 'Adresa portalului; pentru un copil mutat aici, pagina cu absențele; pentru o familie la probă, fără cont, pagina de contact',
            },
        ],
        ...
        sampleData: {
            ...
            portalNote: 'Restul orelor rămân neschimbate, iar orarul actualizat e mereu în portal:',
    ...
    },
    {
        ...
        variables: [
            ...
            { name: 'portalUrl', description: 'Adresa portalului; pentru o familie la probă, fără cont, pagina de contact' },
        ],
        sampleData: {
            firstName: 'Ana',
            groupName: 'Scratch începători',
            ...
            portalNote: 'Orarul actualizat e în portal:',
    ...
    },
    {
        ...
        bodyText: [
            ...
            'Devine: {{toSlot}}',
            '',
            'Prima oră după programul nou e pe {{firstDate}}. {{portalNote}}',
            '',
            '{{portalUrl}}',
            '',
            SIGNATURE,
        ...
        bodyHtml: htmlFrame(
            [
                ...
                paragraph('Prima oră după programul nou e pe {{firstDate}}. {{portalNote}}'),
                linkBlock('portalUrl'),
            ].join('\n'),
        ),
    },
