...
export const TEMPLATE_DEFAULTS: readonly TemplateDefinition[] = [
    ...
    },
    {
        ...
        bodyText: [
            ...
            '{{credits}}',
            '',
            'Te anunțăm în ce grupă îl mutăm. O vezi și în contul tău:',
            '',
            '{{portalUrl}}',
            '',
            'Recuperarea se face în aceeași săptămână — dacă nu se potrivește nicio oră, scrie-ne.',
            '',
            SIGNATURE,
        ].join('\n'),
        bodyHtml: htmlFrame(
            [
                ...
                paragraph('{{credits}}'),
                paragraph('Te anunțăm în ce grupă îl mutăm. O vezi și în contul tău:'),
                linkBlock('portalUrl'),
                paragraph('Recuperarea se face în aceeași săptămână — dacă nu se potrivește nicio oră, scrie-ne.'),
            ].join('\n'),
        ),
    },
    {
