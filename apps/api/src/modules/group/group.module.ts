...
@Module({
    ...
    // release goes through. `ClassSessionModule` because a group moved to another day takes its
    // coming classes with it.
    imports: [EntitiesModule, JwtModule.register({}), EnrollmentModule, ClassSessionModule],
